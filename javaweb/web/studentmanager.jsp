...
<div class="container-fluid">
    <div class="row"style="background-image: url('img/4.jpg');min-height: 590px;background-attachment: fixed">
        <div class="col-sm-10">
            <!-- 顶部搜索部分 -->
            <div class="panel panel-default" style="background: #FFFFFF00">
                <div class="panel-heading"style="background: #FFFFFF00">搜索</div>
                <div class="panel-body">
                    <form role="form" class="form-inline" action="/student?method=search" method="post">
            ...
            <div class="table-responsive">
                ...
                <!-- add框示例（Modal） -->
                <form method="post" action="/student?method=save" class="form-horizontal" style="margin-top: 0px" role="form"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <label for="dormitoryId" class="col-sm-3 control-label">宿舍</label>
                                            <div class="col-sm-9">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            <label for="createDate" class="col-sm-3 control-label">入住时间</label>
                                            <div class="col-sm-9">
