    ...
    <div class="row"style="background-image: url('img/4.jpg');min-height: 600px;background-attachment: fixed">
        <div class="col-sm-10">
            ...
            <div style="margin-top: 0px;" class="table-responsive">
                <form method="post" action="/dormitoryAdmin?method=init" class="form-horizontal" style="margin-top: 0px" role="form"
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" role="form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img src="upload/${dormitoryAdmin.fileName}" id="ph" style="height: 85px;width: 90px;border-radius: 50%;margin-right: 20px;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" readonly required class="form-control" id="id"
                                                               name="id" placeholder="${dormitoryAdmin.id}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" readonly required class="form-control" id="username"
                                                               name="username" placeholder="${dormitoryAdmin.username}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" readonly required class="form-control" id="password"
                                                               name="password" value="" placeholder="${dormitoryAdmin.password}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" readonly required class="form-control" id="name"
                                                               name="name" value="" placeholder="${dormitoryAdmin.name}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" readonly required class="form-control" id="gender"
                                                               name="gender" value="" placeholder="${dormitoryAdmin.gender}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" readonly required class="form-control" id="telephone"
                                                               name="telephone" value="" placeholder="${dormitoryAdmin.telephone}">
                                                    </div>
                                                </div>
                ...
                <%--   upload 修改头像--%>
                <form method="post" action="/dormitoryAdmin?method=upload" enctype="multipart/form-data" class="form-horizontal" style="margin-top: 0px" role="form"
                ...
                <!-- update框示例（Modal） -->
                <form method="post" action="/dormitoryAdmin?method=updateinit"  class="form-horizontal" style="margin-top: 0px" role="form"
                      id="form_data" style="margin: 20px;">
