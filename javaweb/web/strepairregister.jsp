...
<div class="container-fluid" style="background-image: url('img/4.jpg');min-height: 600px;background-attachment: fixed">
    <form method="post" action="/repair?method=studentsave" class="form-horizontal" style="margin-top: 0px" role="form"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <label for="dormitoryAdmin" class="col-sm-3 control-label">宿管</label>
                                <div class="col-sm-9">
                                    <select id="dormitoryAdmin" required class="form-control" name="dormitoryAdminId">
